...
if((i < len)){
var k = (ks[i]);
var G__10040 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__10041 = (i + (1));
m = G__10040;
i = G__10041;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10042 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__10042) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__10042));
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__10044 = c;
var G__10044__$1 = (((G__10044 == null))?null:G__10044.prototype);
if((G__10044__$1 == null)){
return null;
} else {
return (G__10044__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__10046 = c;
var G__10046__$1 = (((G__10046 == null))?null:G__10046.prototype);
if((G__10046__$1 == null)){
return null;
} else {
return (G__10046__$1["render"]);
}
})() == null)))));
});
...
var G__10048 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10048) : reagent.impl.component.as_element.call(null,G__10048));
};
...
var _STAR_current_component_STAR__orig_val__10054 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10055 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10055;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10054;
}});
...
var G__10056 = key;
var G__10056__$1 = (((G__10056 instanceof cljs.core.Keyword))?G__10056.fqn:null);
switch (G__10056__$1) {
...
return ((function (G__10056,G__10056__$1){
...
var c = this;
var G__10061_10063 = (c["cljsRatom"]);
if((G__10061_10063 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10061_10063);
}
...
var renders_10065 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_10066 = cljs.core.first(cljs.core.vals(renders_10065));
if((cljs.core.count(renders_10065) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10065))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10066)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10066], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10064 = name;
switch (G__10064) {
case "":
...
var G__10069 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__10069) : reagent.impl.component.global$module$create_react_class.call(null,G__10069));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__10070 = fiber;
var G__10070__$1 = (((G__10070 == null))?null:(G__10070["type"]));
if((G__10070__$1 == null)){
return null;
} else {
return (G__10070__$1["displayName"]);
}
})();
var parent = (function (){var G__10071 = fiber;
if((G__10071 == null)){
return null;
} else {
return (G__10071["return"]);
}
})();
var path = (function (){var G__10072 = parent;
var G__10072__$1 = (((G__10072 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__10072) : reagent.impl.component.fiber_component_path.call(null,G__10072)));
if((G__10072__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10072__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__10074 = c;
if((G__10074 == null)){
return null;
} else {
return (G__10074["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__10075._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__10077 = c;
if((G__10077 == null)){
return null;
} else {
return (G__10077["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__10079 = c;
if((G__10079 == null)){
return null;
} else {
return G__10079._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__10081 = instance;
if((G__10081 == null)){
return null;
} else {
return (G__10081["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__10082 = instance;
if((G__10082 == null)){
return null;
} else {
return G__10082._currentElement;
}
}
})();
var name = (function (){var G__10083 = elem;
var G__10083__$1 = (((G__10083 == null))?null:(G__10083["type"]));
if((G__10083__$1 == null)){
return null;
} else {
return (G__10083__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__10085 = elem;
if((G__10085 == null)){
return null;
} else {
return (G__10085["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__10086._owner;
}
}
})();
var path = (function (){var G__10087 = owner;
var G__10087__$1 = (((G__10087 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__10087) : reagent.impl.component.component_path.call(null,G__10087)));
if((G__10087__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10087__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__10088 = c;
var G__10088__$1 = (((G__10088 == null))?null:G__10088.constructor);
if((G__10088__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__10088__$1);
}
}
})();
