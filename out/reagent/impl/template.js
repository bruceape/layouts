...
var G__10091 = o;
(G__10091[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10093__i < G__10093__a.length) {G__10093__a[G__10093__i] = arguments[G__10093__i + 0]; ++G__10093__i;}
  args = new cljs.core.IndexedSeq(G__10093__a,0,null);
} 
...
var G__10095 = o;
(G__10095[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__10100 = props;
var G__10100__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10100,cljs.core.cst$kw$id,id):G__10100);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10100__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10101){
var map__10102 = p__10101;
var map__10102__$1 = (((((!((map__10102 == null))))?(((((map__10102.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10102.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10102):map__10102);
var props = map__10102__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10102__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10102,map__10102__$1,props,class$){
return (function (c){
...
});})(map__10102,map__10102__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10104){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10105__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10105,map__10105__$1,on_write){
return (function (){
...
});})(node_value,map__10105,map__10105__$1,on_write))
);
} else {
...
var G__10108 = jsprops;
(G__10108["defaultValue"] = value);

(G__10108["onChange"] = ((function (G__10108,v,value,on_change){
return (function (p1__10107_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10107_SHARP_);
});})(G__10108,v,value,on_change))
);
...
var vec__10111 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10111,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10111,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10111,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___10115 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___10115 == null)){
} else {
var key_10116 = temp__5739__auto___10115;
(jsprops["key"] = key_10116);
}
...
var temp__5739__auto___10117 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___10117 == null)){
} else {
var key_10118 = temp__5739__auto___10117;
reagent.impl.template.oset(jsprops,"key",key_10118);
}
...
var G__10119 = reagent.impl.template.__GT_NativeWrapper();
(G__10119["name"] = c);
...
var G__10120 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10120) : reagent.impl.template.as_element.call(null,G__10120));
} else {
...
var len__4730__auto___10126 = arguments.length;
var i__4731__auto___10127 = (0);
while(true){
if((i__4731__auto___10127 < len__4730__auto___10126)){
args__4736__auto__.push((arguments[i__4731__auto___10127]));

var G__10128 = (i__4731__auto___10127 + (1));
i__4731__auto___10127 = G__10128;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10124){
var G__10125 = cljs.core.first(seq10124);
var seq10124__$1 = cljs.core.next(seq10124);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10125,seq10124__$1);
});
...
break;
default:
var G__10131 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10131;
continue;
...
var n__4607__auto___10133 = a.length;
var i_10134 = (0);
while(true){
if((i_10134 < n__4607__auto___10133)){
(a[i_10134] = reagent.impl.template.as_element((a[i_10134])));

var G__10135 = (i_10134 + (1));
i_10134 = G__10135;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___10136 = a.length;
var i_10137 = (0);
while(true){
if((i_10137 < n__4607__auto___10136)){
var val_10138 = (a[i_10137]);
if(((cljs.core.vector_QMARK_(val_10138)) && ((reagent.impl.template.key_from_vec(val_10138) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10137] = reagent.impl.template.as_element(val_10138));

var G__10139 = (i_10137 + (1));
i_10137 = G__10139;
continue;
} else {
}
...
var ctx = ({});
var vec__10140 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10140,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10140,(1),null);
...
var G__10143 = (cljs.core.count(argv) - first_child);
switch (G__10143) {
case (0):
...
case (1):
var G__10144 = comp;
var G__10145 = jsprops;
var G__10146 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10144,G__10145,G__10146) : reagent.impl.template.global$module$react.createElement.call(null,G__10144,G__10145,G__10146));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10143){
