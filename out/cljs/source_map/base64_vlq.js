...
var digit_5730 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_5731__$1 = (vlq >>> (5));
while(true){
if((vlq_5731__$1 > (0))){
var digit_5732__$1 = (digit_5730 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_5732__$1));

var G__5733 = (vlq_5731__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__5734 = (vlq_5731__$1 >>> (5));
digit_5730 = G__5733;
vlq_5731__$1 = G__5734;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_5730));
}
break;
}
...
var G__5735 = i__$1;
var G__5736 = result__$1;
var G__5737 = shift__$1;
i = G__5735;
result = G__5736;
shift = G__5737;
continue;
